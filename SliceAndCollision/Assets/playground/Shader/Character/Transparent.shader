Shader "Babeitime/Character/Transparent"
	{
    Properties 
	{
		[Header(Main)]
    ...
    SubShader 
	{
        Tags 
		{
            "RenderType"="Transparent" "Queue"="AlphaTest+300" "RenderPipeline" = "UniversalPipeline"
        }
        LOD 200
...
////// 镜面光
                ...
                fixed4 finalRGBA = fixed4(finalColor, _BassRGB_var.a * 0.5) * _Color * 2;
